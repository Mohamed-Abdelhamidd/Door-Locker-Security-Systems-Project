...
/*
 * Description : This function is responsible for setting and updating the password of the system
 */
...
/*
 * Description : The required function to be executed when timer interrupt is fired,
